...
<node TEXT="System Design" LOCALIZED_STYLE_REF="AutomaticLayout.level.root" FOLDED="false" ID="ID_1090958577" CREATED="1409300609620" MODIFIED="1700772070918"><hook NAME="MapStyle" background="#2e3440">
...
<font BOLD="true"/>
<node TEXT="O que é?" POSITION="bottom_or_right" ID="ID_85260301" CREATED="1700772094560" MODIFIED="1700772144220">
<node TEXT=" processo de definir a arquitetura, componentes, interfaces e outras características de um sistema, bem como os procedimentos e dados necessários para a sua implementação." ID="ID_302076906" CREATED="1700772099386" MODIFIED="1700772102698"/>
</node>
</node>
</map>
